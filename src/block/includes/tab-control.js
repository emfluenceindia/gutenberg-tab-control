...
function emfl_tab_control() {
     ...
     */
    registerBlockType('emfl/tab-control', {
        // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
        title: __('Tab Control'), // Block title.
        ...
        edit: (props) => {
            ...
            return (
                <div className={props.className}>
                    <div>
                        <InnerBlocks allowedBlocks={['emfl/tab-strip', 'emfl/tab-content']}/>
                    </div>
                </div>
            );
        },
...
export default emfl_tab_control();
